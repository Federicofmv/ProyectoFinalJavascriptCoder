...
function leerDatosProductos(productoSeleccionado){
  ...
  const infoProducto = {
    ...
    nombre: productoSeleccionado.querySelector('.divProductos__texto').textContent,
    precio: productoSeleccionado.querySelector('.divProductos__precio').textContent.replace('$',''),
    cantidad: 1,
    id: productoSeleccionado.querySelector('.divProductos__boton').getAttribute('data-id') 
  }
  swal.fire({
